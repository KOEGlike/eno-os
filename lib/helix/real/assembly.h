...
#elif defined(__GNUC__) && (defined(ARM) || defined(__arm__) || defined(__thumb__))

#if defined(__ARM_ARCH_8M_MAIN__) || defined(__ARM_ARCH_8M_BASE__) ||       \
	defined(__ARM_ARCH_8_1M_MAIN__) || defined(__ARM_ARCH_8_1M_BASE__) ||   \
	defined(__ARM_ARCH_7M__) || defined(__ARM_ARCH_7EM__)

/* Cortex-M / ARMv7-M and later: pure C, compiler emits smull/clz */
typedef long long Word64;

...
#define SSD16XX_CMD_END_OPTION			0x3f
...
/* "Option for LUT end" (0x3f) value used with the vendor partial
 * waveform for SSD168x panels (WS byte 153 of the waveform setting).
 */
#define SSD16XX_GEN2_END_OPTION_PARTIAL		0x02
